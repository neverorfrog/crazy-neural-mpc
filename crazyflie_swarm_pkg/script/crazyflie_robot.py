...
class CrazyflieRobot:
    ...
    def setup_estimators(self) -> None:
        ...
        linear_velocity_estimator.data_received_cb.add_callback(
            get_linear_velocity_callback
        )
        ...
        angular_velocity_estimator.data_received_cb.add_callback(
            get_angular_velocity_callback
        )
        ...
        acceleration_estimator.data_received_cb.add_callback(
            get_acceleration_callback
        )
